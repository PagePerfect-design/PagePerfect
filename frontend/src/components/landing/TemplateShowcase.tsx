...
const TEMPLATES = [
  { key: 'symphony',    name: 'Symphony',     tag: 'Academic',  color: '#3b82f6', shadow: '0 20px 50px -12px rgba(59,130,246,0.5)' },
    ...
    <section ref={containerRef} className="section-separator relative overflow-hidden py-32 md:py-44">
      ...
      <div className="relative mx-auto max-w-6xl px-6 md:px-8">
        ...
        <div ref={gridRef} className="perspective-1200">
          <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4" style={{ transformStyle: 'preserve-3d' }}>
            {TEMPLATES.map((t, i) => (
              <motion.div
                key={t.key}
