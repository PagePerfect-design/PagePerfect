            ...
            <div className="border-2 border-[#111111] bg-[#FDFCF8]">
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div aria-hidden="true" className="border-b-2 border-[#111111] md:border-b-0 md:border-r-2">
                  ...
                  <div className="bg-white p-6 md:p-10 lg:p-14">
                    <div className="max-w-md">
                      <div
                        className="mb-4 text-[18px] font-bold uppercase text-black/60"
                      ...
                      >
                        ...
                        <p>
                          ...
                          <span className="underline decoration-wavy decoration-red-400 decoration-[0.5px] underline-offset-2">unfinished</span>
                ...
                <div>
                  ...
                  <div className="bg-[#fafaf5] p-6 md:p-10 lg:p-14">
                    <div className="max-w-md">
