  ...
  return (
    <section className="relative overflow-hidden py-32 text-center md:py-44">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[700px] w-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse,rgba(79,143,255,0.1)_0%,transparent_70%)]" />
        <div className="absolute left-[20%] top-[30%] h-[400px] w-[400px] rounded-full bg-[radial-gradient(ellipse,rgba(139,92,246,0.06)_0%,transparent_70%)]" />
      ...
      <div ref={ref} className="relative mx-auto max-w-3xl px-6 md:px-8">
        ...
        >
          <h2 className="font-display text-display-lg font-bold tracking-[-0.03em]">
          ...
          >
            <Link
              href="/app"
              className="group inline-flex h-14 items-center gap-3 rounded-full bg-white px-10 text-[17px] font-semibold text-[#0a0a0f] shadow-[0_0_60px_-12px_rgba(255,255,255,0.3)] transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_80px_-8px_rgba(255,255,255,0.4)]"
            >
