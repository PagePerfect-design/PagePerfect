  ...
  return (
    <section className="relative border-t-2 border-[#111111] bg-[#FDFCF8] py-28 text-center md:py-40">
      <div className="mx-auto max-w-3xl px-6 md:px-8">
        ...
        {/* Decorative rule */}
        <div className="mx-auto mb-16 h-[2px] w-16 bg-[#0033ff]" />
        ...
        <div className="mt-12 flex flex-col items-center gap-5">
          <Link
            href="/app"
            className="inline-flex h-12 items-center bg-[#0033ff] px-12 font-mono text-[11px] uppercase tracking-[0.12em] text-white transition-all duration-75 hover:bg-[#0022cc]"
          >
            Open the Editor
          </Link>
