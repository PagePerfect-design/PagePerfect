  ...
  return (
    <details className="card p-4 mb-4">
      <summary className="flex cursor-pointer list-none items-center justify-between">
        <span className="font-semibold text-text-primary">Template notes</span>
        <span className="small-mono text-text-ghost">Click to expand</span>
      </summary>

      <div className="mt-3 text-sm leading-6 text-text-primary">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h4 className="font-semibold text-text-primary mb-2">🎼 Academic & Scholarly</h4>
          ...
          <div>
            <h4 className="font-semibold text-text-primary mb-2">🖼️ Trade & Commercial</h4>
            <ul className="list-disc space-y-1 pl-5 text-xs">
          ...
          <div>
            <h4 className="font-semibold text-text-primary mb-2">🎨 Creative & Experimental</h4>
            <ul className="list-disc space-y-1 pl-5 text-xs">
              <li><span className="font-semibold">Avant-Garde Canvas</span> — Experimental design with creative freedom</li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-text-primary mb-2">📚 Legacy Templates</h4>
            <ul className="list-disc space-y-1 pl-5 text-xs">
