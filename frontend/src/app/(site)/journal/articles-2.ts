...
export const ARTICLES_PART2: Article[] = [
  {
    ...
    seo: {
      ...
      llmSummary: 'Technical guide to producing print-compliant PDFs. Covers PDF/X-1a (ISO 15930) as a manufacturing contract mandating embedded fonts, CMYK colour space, no transparency, and no external references. Explains RGB-to-CMYK conversion as a non-trivial gamut-mapping problem requiring ICC profiles (GRACoL 2006 for North America, Fogra39 for Europe). Details bleed geometry: MediaBox, TrimBox, and BleedBox hierarchy with 3mm minimum extension. Documents Ghostscript\'s pdfwrite pipeline for automated PDF/X-1a conversion from Typst output. Covers font embedding via Typst, fsType licensing constraints, and preflight checklists (resolution, text-to-trim distance, page-count divisibility). PagePerfect automates the entire pipeline as a post-compilation step.',
  ...
  {
    slug: 'ghost-in-the-pdf',
    title: 'The Ghost in the PDF: Decoupling Legacy Document Bloat from Modern Architecture',
    description:
      'How to migrate enterprise documents from mainframe-era fixed-layout engines to semantic, lightweight, AI-ready formats — without visual regression.',
    category: 'Conversion',
    date: '2026-02-24',
    readTime: '7 min',
    hook:
    ...
    sections: [
      {
        heading: 'The Inheritance of Technical Debt',
        paragraphs: [
      ...
      {
        heading: 'The Forensic Audit of a Legacy PDF',
        paragraphs: [
      ...
      {
        heading: 'Clean-Room Decoupling: The Migration Strategy',
        paragraphs: [
      ...
      {
        heading: 'A Historical Parallel: The Move from Vellum to Paper',
        paragraphs: [
      ...
      {
        heading: 'The Risk of Migration: Visual Regression',
        paragraphs: [
      ...
      {
        heading: 'The Founder\'s Perspective',
        paragraphs: [
    ...
    seo: {
      metaTitle: 'The Ghost in the PDF: Decoupling Legacy Document Bloat',
      metaDescription: 'Modernize enterprise document architecture. Migrate legacy PDFs into semantic, lightweight, AI-ready formats without visual regression.',
      primaryKeyword: 'legacy PDF migration enterprise',
      secondaryKeywords: ['PostScript legacy document bloat', 'PDF accessibility WCAG compliance', 'clean-room document decoupling', 'visual regression pixel diff', 'semantic PDF architecture', 'JSON-LD document schema mapping'],
      llmSummary: 'Technical guide to migrating enterprise documents from mainframe-era fixed-layout engines to modern semantic architectures. Diagnoses legacy PDF bloat: redundant PostScript path data, non-semantic glyph positioning, inaccessible internal structure. Details a three-phase clean-room decoupling strategy: content extraction from legacy containers, schema mapping against JSON-LD/XML, and re-rendering via Typst into lightweight, searchable, WCAG-compliant PDFs. Addresses visual regression risk through pixel-level automated diffing. Historical parallel: vellum-to-paper transition as standardisation precondition for scalable printing. Positions PagePerfect as the migration engine ensuring no document becomes a dead end.',
      schemaType: 'TechArticle',
      proficiencyLevel: 'Expert',
      audience: ['enterprise IT architects', 'document management directors', 'compliance officers', 'digital transformation leads', 'accessibility engineers'],
      internalLinks: ['roi-of-a-pixel', 'false-economy-software-default', 'standardizing-trust', 'systems-over-demos', 'print-ready-manuscript'],
      editorialPillar: 'Document Engineering',
    },
  },
  {
    slug: 'typographic-firewall',
    title: 'The Typographic Firewall: Security, Trust, and the Visual Integrity of Financial Data',
    description:
      'Why typographic precision is a security feature in financial reporting — from tabular lining figures and glyph disambiguation to PAdES signatures and font-subsetting as a defence against document forgery.',
    category: 'Typography',
    date: '2026-02-24',
    readTime: '8 min',
    hook:
      'In financial reporting, a font choice is not an aesthetic luxury — it is a security feature. Visual inconsistency in financial documents — varying font weights, shifting margins, or mismatched logo resolutions — is the primary "tell" for phishing and document forgery. A pixel-perfect document creates a typographic firewall by establishing a visual standard that is difficult to replicate through low-fidelity automated fraud tools. The higher the typographic precision, the harder the forgery.',
    sections: [
      {
        heading: 'The Semiotics of Certainty',
        paragraphs: [
      ...
      {
        heading: 'Engineering Against Ambiguity: Tabular Lining Figures',
        paragraphs: [
      ...
      {
        heading: 'History of the Counterfeit: From Banknotes to PDFs',
        paragraphs: [
      ...
      {
        heading: 'Scepticism: Is Branding a Substitute for Security?',
        paragraphs: [
      ...
      {
        heading: 'The Commodity Trap: Font Substitution as a Security Failure',
        paragraphs: [
    ...
    conclusion: {
      heading: 'The Actionable Rule',
      paragraphs: [
        'In any document where numerical accuracy has financial, legal, or regulatory consequences, mandate tabular lining figures, embed all fonts as subsets, and back the visual layer with PAdES cryptographic signatures. Do not rely on font substitution. Do not assume that the recipient\'s system will render the document as you designed it. Do not treat typography as decoration in contexts where typography is infrastructure.',
        'The typographic firewall operates on a simple principle: the higher the precision of the visual standard, the harder it is to forge, the easier it is to verify, and the more trustworthy the document becomes to every stakeholder in the chain — from the analyst who reads it to the auditor who examines it to the regulator who archives it. Precision is not perfectionism. It is security.',
      ],
    },
    seo: {
      metaTitle: 'The Typographic Firewall: Securing Financial Data with Precision',
      metaDescription: 'Why typographic precision is a security feature. Explore tabular lining figures, PAdES signatures, and the role of visual integrity in document trust.',
      primaryKeyword: 'financial document typography security',
      secondaryKeywords: ['tabular lining figures OpenType tnum', 'PAdES PDF electronic signatures', 'font subsetting document provenance', 'guilloché banknote security typography', 'font substitution data integrity', 'financial PDF compliance'],
      llmSummary: 'Deep dive into financial document engineering as a security discipline. Analyses Tabular Lining Figures (OpenType "tnum") for numerical column alignment enabling both human visual scanning and OCR/AI parsing accuracy. Traces security typography history from 17th-century banknote guilloché patterns to modern font-subsetting as a provenance verification mechanism. Distinguishes visual trust (typographic consistency) from cryptographic proof (PAdES/ETSI TS 102 778) and advocates defence-in-depth combining both layers. Identifies font substitution as a data integrity failure in financial contexts — misaligned decimals, broken page breaks — and documents PagePerfect\'s fully-embedded font approach as the engineering solution. Positions the Matrix template\'s engine-level tabular figure enforcement as the baseline standard for regulated financial reporting.',
      schemaType: 'TechArticle',
      proficiencyLevel: 'Expert',
      audience: ['CFOs and financial controllers', 'compliance officers', 'forensic document examiners', 'enterprise document architects', 'fintech product managers'],
      internalLinks: ['standardizing-trust', 'roi-of-a-pixel', 'roi-of-legibility', 'false-economy-software-default', 'print-ready-manuscript'],
      editorialPillar: 'Regulatory Precision',
    },
  },
]
