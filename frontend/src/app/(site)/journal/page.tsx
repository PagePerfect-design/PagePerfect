    ...
    <main id="main">
      ...
      <section className="border-b-2 border-[#111111] py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <SectionLabel>Vol. I — Typography &amp; Conversion</SectionLabel>
          <h1 className="font-display text-h1 font-extrabold tracking-tighter text-[#111111]" style={{ lineHeight: 0.95 }}>
            The Journal
          </h1>
          <p className="mt-6 max-w-2xl font-body text-lg leading-relaxed text-[#444444]">
          ...
          <p className="mt-3 font-body text-base leading-relaxed text-[#777777]">
            ...
            <aside className="hidden md:block">
              <div className="sticky top-16">
                ...
                <div className="space-y-2">
                  {Object.entries(categoryCounts).map(([cat, count]) => (
                    <div key={cat} className="flex items-center justify-between">
                      <span className="font-display text-[0.8125rem] text-[#444444]">{cat}</span>
                      <span className="font-mono text-[0.625rem] text-[#999]">{count}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-8 border-t border-[#e5e5e0] pt-6">
                  ...
                  <p className="font-body text-[0.8125rem] leading-relaxed text-[#777]">
                ...
                {ARTICLES.map((article, i) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="mt-1 shrink-0 font-mono text-[0.625rem] text-[#ccc]">
      ...
      <section className="border-t-2 border-[#111111] py-16">
        <div className="mx-auto max-w-7xl px-6 md:px-8 text-center">
          <p className="font-mono text-[0.625rem] uppercase tracking-[0.15em] text-[#999] mb-4">
          ...
          <p className="mx-auto mt-4 max-w-lg font-body text-base text-[#5c5c5c]">
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            ...
            <Link
              href="/docs"
              className="border border-[#111111]/20 px-8 py-2.5 font-mono text-[10px] uppercase tracking-[0.1em] text-[#111111]/60 transition-all duration-75 hover:border-[#111111] hover:text-[#111111]"
            >
              Read Docs
            </Link>
          </div>
