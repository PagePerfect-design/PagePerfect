...
export const SECTIONS: NavSection[] = [
  ...
  { id: 'compile-modes', label: 'Compile Modes' },
  { id: 'standard-mode', label: 'Standard Mode' },
  { id: 'input', label: 'Manuscript Input' },
  { id: 'genre-detection', label: 'Genre Detection' },
  ...
  { id: 'template-verse', label: 'Verse' },
  { id: 'template-thesis', label: 'Thesis' },
  { id: 'template-memoir', label: 'Memoir' },
  { group: 'Publishing', id: 'kdp', label: 'Publish to Amazon KDP' },
  { id: 'trim-sizes', label: 'Trim Sizes' },
  { id: 'gutters', label: 'Dynamic Gutter' },
  { id: 'spine', label: 'Spine Width' },
  { group: 'Automation', id: 'automation', label: 'Automate Your Pipeline' },
  ...
  { group: 'Support', id: 'troubleshooting', label: 'Diagnosing Issues' },
]
